-- Taken from hastec hidden module
--
-- Changes: * added touch related events
--          

{-# LANGUAGE ForeignFunctionInterface, EmptyDataDecls, GADTs,
             FlexibleInstances, OverloadedStrings #-}
module Html5.Callback (setCallback, JSFun (..), mkCallback, Event (..),
...
data Event a where
  ...
  OnMouseOut  :: Event (IO ())
  OnTouchStart:: Event (IO ())
  OnTouchMove :: Event (IO ())
  OnTouchEnd  :: Event (IO ())
